...
TOOLTIP='''
Generate g-code from a Path that is compatible with the Maslow controller.

import maslow_post
maslow_post.export(object,"/path/to/file.ncc")
'''
...
parser.add_argument('--preamble', help='set commands to be issued before the first command, default="G90"')
...
# CORNER_MAX = {'x':300, 'y':300, 'z':300 }
CORNER_MAX = {'x':1200, 'y':600, 'z':100 }
PRECISION = 4
...
SUPPRESS_COMMANDS = [ 'G98', 'G80', 'G17', 'G54', 'G40', 'G41', 'G42', 'G43', 'G44', 'G49' ]
...
def export(objectslist,filename,argstring):
    ...
    # write header
    if OUTPUT_HEADER:
        gcode += linenumber() + "(Exported by FreeCAD for MaslowCNC)\n"
